...
public class FriendsTest  extends GWTTestCase {
    ...
    public void testFriendsAreFriends () {
        JavaScriptObject jso = getAreFriendsResponse ();
        JsArray<FriendInfo> areFriends = jso.cast ();
        Assert.assertEquals (  1, areFriends.length () );
        FriendInfo friendInfo = areFriends.get ( 0 );
    ...
    public void testFriendsGet () {
        ...
        Assert.assertTrue ( friendList.length() > 10 );
    ...
    public native JavaScriptObject getAreFriendsResponse () /*-{
           return [{"uid1":744450545,"uid2":709281400,"are_friends":true}]
     }-*/;
