...
public class Comment extends JavaScriptObject {
     ...
     */
    public final native String getXid() /*-{ return this.xid; }-*/;
     ...
     */
	public final native String replyXid() /*-{ return this.reply_xid +""; }-*/;


	/**
	 * Create a comment object with xid and comment. This object can be passed directly 
	 * to a native javascript function.
