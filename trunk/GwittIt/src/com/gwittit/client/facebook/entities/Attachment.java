...
/**
 * Wrapp attachment object. This object is either retreived from stream get calls,
 * or you can publish it in our own stream
 *  
...
public class Attachment extends JavaScriptObject { 
     ...
     * @param href URL
     */
    public final native void setHref ( String href ) /*-{ this.href=href; }-*/;
     ...
     */
    public final native void setCaption( String caption ) /*-{ this.caption=caption; }-*/;
    ...
    public static native Attachment newInstance () /*-{ return eval ('({})') }-*/;
